...
CASOS_TESTE = [
    ...
    {"descricao_legada": "CABO ISOL.XLPE - 0,6/1KV 2,5MM2", "descricao_sinapi": "CABO DE COBRE FLEXIVEL ISOLADO,  2,5 MM², ANTI-CHAMA 0,6/1,0 KV, PARA CIRCUITOS TERMINAIS - FORNECIMENTO E INSTALACAO. AF_03/2023", "codigo_esperado": "91927", "expectativa": "ACEITACAO FIO CABO equivalencia"},
    ...
    {"descricao_legada": "TELA ARAME GALVANIZADO FIO 12 BWG 2,77mm DN 1 1/4 4x4 cm", "descricao_sinapi": "INSTALAÇÃO DE TELA DE ARAME GALVANIZADA, PARA ALAMBRADO COM TUBOS DE AÇO, QUADRANGULAR / LOSANGULAR, FIO 2,77 MM (12 BWG), MALHA 5 X 5 CM, H = 2 M. AF_12/2025", "codigo_esperado": "106464", "expectativa": "ACEITACAO TELA variacao"},
